  ...
  return (
    <header className="h-16 border-b border-border bg-background flex items-center justify-between px-4 sm:px-6 sticky top-0 z-30 shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        {/* User Dropdown Profile (click-toggle) */}
        <div className="relative">
          <button
          ...
          {menuOpen && (
            <>
              ...
              <div className="absolute right-0 top-full mt-2 w-48 bg-card border border-border rounded-xl shadow-lg z-50 py-2 origin-top-right">
                ...
                <div className="py-1">
                  ...
                  <button onClick={() => { setMenuOpen(false); router.push("/settings"); }} className="w-full flex items-center gap-2 px-4 py-2 text-sm text-foreground hover:bg-muted">
